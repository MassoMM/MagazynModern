    ...
    public partial class FormFlat : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                mydbDataSet.flattbl.AddflattblRow(mydbDataSet.flattbl.NewflattblRow());
                flattblBindingSource.MoveLast();
                txtkolekcja.Focus();
                con.Close();
            }
            catch(Exception ex)
            {
                ...
                mydbDataSet.flattbl.RejectChanges();
                con.Close();
            }
        }
        ...
        private void FormProduct_Load(object sender, EventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["newConnectionString"].ConnectionString);
            con.Open();
            // TODO: Ten wiersz kodu wczytuje dane do tabeli 'mydbDataSet.flattbl' . Możesz go przenieść lub usunąć.
            this.flattblTableAdapter.Fill(this.mydbDataSet.flattbl);
            con.Close();
            LoadTheme();
            Edit(false);
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                Edit(false);
                flattblBindingSource.EndEdit();
                flattblTableAdapter.Update(mydbDataSet.flattbl);
        ...
        private void dataGridView1_KeyPress(object sender, KeyPressEventArgs e)
        {
            if(e.KeyChar == (char)13)//Enter
            {
                ...
                {
                    flattblBindingSource.RemoveCurrent();
                }
            }
        ...
        {
            SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["newConnectionString"].ConnectionString);
            string sqlcmd = "SELECT * FROM flattbl WHERE kolekcja LIKE '" + txtSearch.Text + "%'" ;
            con.Open();
        ...
        {
            SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["newConnectionString"].ConnectionString);
            string sqlcmd = "SELECT * FROM flattbl WHERE tkanina LIKE '" + txtSearch2.Text + "%'";
            con.Open();
            SqlCommand cmd = new SqlCommand(sqlcmd, con);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dataGridView1.Columns[e.ColumnIndex].Name == "QR")
            {
                ...
                FormQRFlat w1 = new FormQRFlat(this);
                w1.ShowDialog();
